    ...
    return (
        <div>
            {quote && (
                <div
                    key={quote.quoteLine}
                    className="relative flex flex-col px-4 py-9 rounded-xl shadow-xs border border-2 border-accent/30 ring-2 ring-foreground/2 ring-offset-2 ring-offset-muted-foreground/4 ring-inset"
                >
